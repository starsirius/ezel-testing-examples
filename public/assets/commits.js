...
module.exports.CommitsView = CommitsView = (function(_super) {
  __extends(CommitsView, _super);

  function CommitsView() {
    this.render = __bind(this.render, this);
    _ref = CommitsView.__super__.constructor.apply(this, arguments);
    return _ref;
  }

  CommitsView.prototype.initialize = function() {
    return this.collection.on("sync", this.render);
  };

  CommitsView.prototype.render = function() {
    return this.$("#commits-list").html(listTemplate({
      commits: this.collection.models
    }));
  };

  CommitsView.prototype.events = {
    "change .search-input": "changeRepo"
  };

  CommitsView.prototype.changeRepo = function(e) {
...
},{"../../collections/commits.coffee":4,"./templates/list.jade":2,"backbone":6,"jquery":9,"sharify":10}],2:[function(require,module,exports){
...
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (commits) {
// iterate commits
;(function(){
  var $$obj = commits;
...
buf.push("<li>" + (jade.escape(null == (jade_interp = commit.get('commit').message) ? "" : jade_interp)) + "</li>");
    }

  } else {
    var $$l = 0;
    for (var $index in $$obj) {
      $$l++;      var commit = $$obj[$index];
...
}("commits" in locals_for_with?locals_for_with.commits:typeof commits!=="undefined"?commits:undefined));;return buf.join("");
};
},{"jade/runtime":8}],3:[function(require,module,exports){
require('jquery')(require("../apps/commits/client.coffee").init);


},{"../apps/commits/client.coffee":1,"jquery":9}],4:[function(require,module,exports){
var Backbone, Commit, Commits, sd, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
module.exports = Commits = (function(_super) {
  __extends(Commits, _super);

  function Commits() {
    _ref = Commits.__super__.constructor.apply(this, arguments);
    return _ref;
  }

  Commits.prototype.model = Commit;

  Commits.prototype.url = function() {
    return "" + sd.API_URL + "/repos/" + this.owner + "/" + this.repo + "/commits";
  };

  Commits.prototype.initialize = function(models, options) {
    return this.owner = options.owner, this.repo = options.repo, options;
  };
...
},{"../models/commit.coffee":5,"backbone":6,"sharify":10}],5:[function(require,module,exports){
var Backbone, Commit, sd, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
module.exports = Commit = (function(_super) {
  ...
  function Commit() {
    _ref = Commit.__super__.constructor.apply(this, arguments);
    return _ref;
  }

  Commit.prototype.url = function() {
    return "" + sd.API_URL + "/repos/" + this.collection.owner + "/" + this.collection.repo + "/" + (this.get('sha'));
  };
...
},{"backbone":6,"sharify":10}],6:[function(require,module,exports){
//     Backbone.js 1.1.2
